...
import { FiUser, FiMail, FiLock, FiArrowLeft, FiCheckCircle, FiRefreshCw } from "react-icons/fi";
...
export default function Register() {
  ...
  const { register, resendVerificationEmail, refreshUser, logout, user } = useAuth();
        ...
        >
          ...
          <p className="text-warmGray-600 dark:text-warmGray-400 text-sm">
            {showVerification
              ...
              : "Sign up to start your food journey (Gmail only)"}
          </p>
        </motion.div>
          ...
          <>
            ...
            >
              ...
              <div className="relative">
                <FiUser className="absolute left-4 top-1/2 -translate-y-1/2 text-warmGray-500 dark:text-warmGray-400 w-5 h-5" />
                <input
                  type="text"
            ...
            <motion.button
              ...
              disabled={loading}
              className="w-full mt-8 bg-secondary-500 hover:bg-secondary-600 text-white font-bold py-4 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50"
            >
          ...
          <>
            ...
            >
              ...
              <p className="text-warmGray-700 dark:text-warmGray-300">
                We've sent a verification link to <span className="font-semibold text-primary-600 dark:text-primary-400">{email}</span>
              </p>
